		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibmzpurchase07zpurchase07-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibmzpurchase07zpurchase07-display": {
								"semanticObject": "comibmzpurchase07zpurchase07",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibm.zpurchase07.zpurchase07",
									"url": sap.ui.require.toUrl("com/ibm/zpurchase07/zpurchase07")
								}
							}
						}
					}
